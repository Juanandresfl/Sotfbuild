...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
   ...
   <%@ page import="services.ObjetoBodegaDao"%>
   <%@ page import="entities.Empleado"  %>
   <%@ page import="entities.Almacenista"  %>
   <%@ page import="entities.ObjetoBodega"%>
  ...
  <body>
    ...
    <!-- ##### Preloader ##### -->
     ...
     <!-- inicio nav -->
        ...
        ObjetoBodegaDao ob=new ObjetoBodegaDao();
        List<ObjetoBodega> o=ob.objetosByAlmace(id);
...
%>
      ...
      <button type="button" name="button" onclick="convertir('Idtable')" class="btn btn-warning " id="centrar"> <i class="fas fa-download"></i> &nbsp Descargar archivo </button>
      </div>
<script type="text/javascript">
    ...
    // Specify file name
    filename = filename?filename+'.xls':'Reporte_Bodega.xls';
