            ...
            <div class="col-12 col-sm-12 col-md-12">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><%=alm.getNombre() %></td>
                    <td><%=alm.getObra().getNombre()%></td>
                    <td><%=e.getNombre()+" "+e.getApellido() %></td>
                    <td><%=alm.getTelefono() %></td>
                    <td><%=alm.getDireccion() %></td>
                    <td> <button type="button" class="btn btn-warning"><a href="Almacenes.jsp"><font color=black>Ver <i class="far fa-eye"></font></a></i></button></td>
                    </tr>
