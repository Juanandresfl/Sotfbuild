  ...
  <body>
    <!-- ##### Preloader ##### -->
     ...
     <!-- inicio nav -->
          ...
          <a class="navbar-brand" href="index.jsp"> <img src="img/logo.png" width="120px"></a>
        ...
        <h3 align="center">Registrar Administrador</h3>
        <div class="container">
            <form id="administrar" action="RegistrarAdministradorController" method="post">
