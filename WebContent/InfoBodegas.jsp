  ...
  <body>
    <!-- ##### Preloader ##### -->
     ...
     <form class="form-inline my-2 my-lg-0" action="DestruirSesionController" method="post">
        ...
        <h3 align="center"> Informacion Bodegas</h3>
              ...
              <table class="table table-hover">
                ...
                <% for(Bodega e:b){%>
                  <tr>
                    ...
                    <td><%=e.getTelefono()%></td>
                    <td>
                      <button type="button" class="btn btn-warning"><a href="Bodegas.jsp?id=<%=e.getIdBodega()%>" ><font color=black>Ver <i class="far fa-eye"></font></a></i></button>
                    </td>
                  </tr>
              <%   } %>
                </tbody>
