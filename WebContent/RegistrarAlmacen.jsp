  ...
  <body>
    <!-- ##### Preloader ##### -->
     ...
     <!-- inicio nav -->
        ...
        <h3 align="center">Registrar Almacen</h3>
        <div class="container">
            <form id="administrar" action="RegistrarAlmacenController" method="post">
                <div class="row jumbotron">
              <div class="col-6 col-md-6 col-sm-6">
                <div class="form-group">
                  <label for="exampleInputText1">Nombre del almacen</label>
                  <input type="text" name="nombre" class="form-control" id="exampleInputText1" aria-describedby="emailHelp" placeholder="Almacen Sevilla">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="exampleInputText1">Seleccionar Obra</label> <br>
                  	<%
							ObraDao oDao = new ObraDao();

							List<Obra> obras = oDao.MostrarObras();
						...
						%>
						<select class="form group btn btn-warning" name="obra">
							<%
								for (Obra o : obras) {
							%>
							<option value="<%=o.getIdObra()%>"><%=o.getNombre()%></option>
							<%
								}
								}
							%>
              ...
              <div class="col-6 col-md-6 col-sm-6">
                ...
                <div class="form-group">
                  <label for="exampleInputText1">Almacenista</label> <br>
                  <%
							EmpleadoDao irDao = new EmpleadoDao();

							List<Empleado> empleados = irDao.EmpleadoAlmacenista();

							if (empleados.isEmpty()) {
						%>

						<div class="alert alert-dark" role="alert">No Hay
							Almacenistas Disponibles!</div>
						<span name="id" value=" "></span>
						<%
							} else {
						%>
	...
	%>
	<SCRIPT>
		Swal.fire('Almacen Registrado!', 'El almacen ha sido registrada con exito!',
				'success')
	</SCRIPT>
	<%
		} else {
	%>
	<SCRIPT>
	Swal.fire('¡Error!','¡el almacen no ha podido ser registrada!','error')
	</SCRIPT>
	<%
		}
	%>
